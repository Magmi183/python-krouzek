...
Pravidla:
    Počítač si myslí náhodné čtyřmístné číslo a hráč se jej snaží uhodnout. Hraje se na kola - v každém kole hráč udělá
    jeden tip a počítač mu řekne, kolik tipl správně číslic a zároveň jsou na správném místě (býci) a kolik tipl správně
    číslic, ale nejsou na správném místě (krávy). Např. Pokud si počítač myslí číslo 4271 a hráč tipne 1234,
